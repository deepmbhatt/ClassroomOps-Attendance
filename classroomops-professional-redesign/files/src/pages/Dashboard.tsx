...
function AdminDashboard({ data }: { data: Awaited<ReturnType<typeof loadAppData>> }) {
  ...
  const shortcuts = [
    ...
    { to: '/admin/students', label: 'Manage roster', detail: 'Add courses, import or edit students', icon: <Users size={18} /> },
  ...
  return (
    <>
      ...
      <div className="kpi-grid">
        ...
        <Kpi label="Items to review" value={unresolved + lowConfidence} icon={<MessageSquareWarning size={19} />} detail="Issues and uncertain matches" />
      </div>
