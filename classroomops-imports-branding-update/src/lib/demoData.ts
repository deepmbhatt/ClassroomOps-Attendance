...
export const demoAssessments: Assessment[] = [
  { id: 'assessment-1', course_id: 'course-1', course_code: 'CS601', title: 'INSEM 1', max_marks: 20, published: true, academic_year: '2026-27', semester: 'Semester 1', assessment_type: 'internal' },
  { id: 'assessment-2', course_id: 'course-1', course_code: 'CS601', title: 'Practical', max_marks: 20, published: false, academic_year: '2026-27', semester: 'Semester 1', assessment_type: 'lab' },
]

export const demoMarks: Mark[] = [
  { id: 'mark-1', assessment_id: 'assessment-1', student_id: 'student-1', student_name: 'Ananya Rao', value: 17, published: true },
  { id: 'mark-2', assessment_id: 'assessment-1', student_id: 'student-2', student_name: 'Rohan Mehta', value: 15, published: true },
]
