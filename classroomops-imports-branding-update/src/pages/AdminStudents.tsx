...
const studentCsvFormat = `Student ID,Full Name,Email,Phone,Course Codes
CSE001,Ananya Rao,ananya@college.edu,+91 90000 00001,CS601;CS642
CSE002,Rohan Mehta,rohan@college.edu,+91 90000 00002,CS601
CSE003,Sara Khan,sara@college.edu,+91 90000 00003,CS642`
    ...
    <>
      ...
      <div className="two-column import-layout">
        <Card>
          ...
          <p className="muted-copy">Save Excel as CSV. Separate multiple courses with semicolons, like <b>CS601;CS642</b>. The frontend cannot safely create Supabase Auth users in bulk; this import validates the roster and prepares clean rows. For automatic Auth user creation, use a Supabase Edge Function with the service-role key.</p>
          ...
          <div className="import-actions">
            ...
            <IconButton disabled={preview.errorCount > 0}><Upload size={16} />Stage roster</IconButton>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="table-scroll">
            <table>
              <thead><tr><th>Row</th><th>Student</th><th>Email</th><th>Courses</th><th>Status</th></tr></thead>
              <tbody>
